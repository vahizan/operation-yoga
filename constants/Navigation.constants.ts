...
export const NAVIGATION_MENU_VALUES: NavMenuType[] = [{
    ...
    },
    {
        ...
        children: [
            ...
            {root: {title:"Teachers' Training Courses", link: "/veda-yogshala/teacher-training-courses"}},
            {root: {title:"Language Courses", link: "/veda-yogshala/language-courses"}},
            {root: {title:"Indian Cooking Classes", link: "/veda-yogshala/indian-cooking-classes"}},
            {root: {title:"Pranayama & Meditation", link: "/veda-yogshala/pranayama-meditation"}},
            {root: {title:"Mantra Chanting", link: "/veda-yogshala/mantra-chanting"}},
    ...
    },
    {
        ...
        children: [
            {root: {title:"Traditional Massage", link: "/veda-spa/traditional-massage"}},
    ...
    },
    {
        ...
        children: [
            ...
            {root: {title:"More about Ashtanga", link: "/blog/more-about-ashtanga"}},
            {root: {title:"Mountain Pose vs Downward Dog", link: "/blog/mountain-pose-vs-downward-dog"}},
        ]
    },
    {
